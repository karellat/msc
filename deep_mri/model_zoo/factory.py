from deep_mri.model_zoo import models_3d, encoders
...
def model_factory(model_name, **model_args):
    ...
    if mod_type.lower() == "3d":
        return models_3d.factory(model_name, **model_args)
    elif mod_type.lower() == "encoder":
        return encoders.factory(model_name, **model_args)
    elif mod_type.lower() == "2d":
        return models_2d.factory(model_name, **model_args)
    else:
