import json
with open('/home/karelto1/master_thesis/configs/hosseini2.json', 'r') as f:
    config = json.load(f)
...
subject_model = tf.keras.models.load_model("/home/karelto1/master_thesis/logs/final_3d/hoseini_subjects/models")
random_model = tf.keras.models.load_model("/home/karelto1/master_thesis/logs/final_3d/hoseini_random/models")
...
for i in range(1, 9):
    subject_model_2.layers[i].set_weights(subject_model.layers[i].get_weights())
