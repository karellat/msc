import json
with open('/home/karelto1/master_thesis/configs/payan_classification.json', 'r') as f:
    config = json.load(f)


import tensorflow as tf
from deep_mri.train.config_parser import config_to_model, config_to_ds, config_epochs, config_batch_size, \
    config_to_callbacks

subject_model = tf.keras.models.load_model("/home/karelto1/master_thesis/logs/final_3d/payan_encoder/models/")
